...
ex) tts --text "안녕하세요." --model_path /home/user/coqui-ai-TTS/run/training/karina/ --config /home/user/coqui-ai-TTS/run/training/karina/config.json --out_path /home/user/output.wav --language_idx ko --speaker_wav /home/user/coqui-ai-TTS/datasets/karina/wavs/audio85.wav
```bash
