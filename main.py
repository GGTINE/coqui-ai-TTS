...
config_dataset = BaseDatasetConfig(
    formatter="ljspeech",
    dataset_name="iu",
    path="/home/bikim/tts/datasets/iu",
    meta_file_train="/home/bikim/tts/datasets/iu/metadata.txt",
    language="ko",
)
...
SPEAKER_REFERENCE = [
    "/home/bikim/tts/datasets/iu/wavs/audio58.wav"  # speaker reference to be used in training test sentences
]
